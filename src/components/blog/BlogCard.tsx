            ...
            <div className="relative aspect-[16/9] overflow-hidden">
              ...
              {post.category && (
                <div className="absolute top-4 left-4">
                  <span className="inline-flex items-center px-3 py-1.5 bg-white/90 backdrop-blur-sm rounded-full text-xs font-bold text-primary shadow-lg">
                    <span className="w-2 h-2 rounded-full bg-gradient-to-r from-primary to-secondary mr-2" />
                    {post.category}
                  </span>
                </div>
              )}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <h3 className="font-heading font-bold text-xl md:text-2xl text-white mb-2 line-clamp-2 group-hover:text-accent transition-colors duration-300">
                  {post.title}
                </h3>
                {/* Meta */}
        ...
        <Link href={`/${post.slug}/`} className="block relative aspect-[16/10] overflow-hidden">
          ...
          {post.category && (
            <div className="absolute top-3 left-3 z-10">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/95 backdrop-blur-sm rounded-full text-xs font-bold text-primary shadow-md">
          ...
          {post.readingTime && (
            <div className="absolute top-3 right-3 z-10">
              <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-black/50 backdrop-blur-sm rounded-full text-xs font-medium text-white">
