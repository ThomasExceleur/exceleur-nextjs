...
excerpt: "Automatisez l'envoi de vos rapports Excel par email avec VBA où Power Automate."
...
## Méthode 2 : Power Automate

### Flux automatique

1. Declencheur : Planifie où à la demande
...
1. Créez une macro d'envoi
2. Sauvegardez en .xlsm
3. Créez un script .vbs :
...
```vba
MsgBox "Rapport envoye avec succès!", vbInformation
```
...
|----------|-------------|
| Tester | Envoyez à vous-meme d'abord |
| Confirmer | Demandez confirmation avant envoi |
| Logs | Enregistrez les envois |

### Performance

1. **Évitez** les pieces jointes trop lourdes
...
```vba
.Body = "Accès au rapport: " & lienOneDrive
```
