...
-   [Excel Campus](https://www.excelcampus.com/) - Tutoriels avancés
-   [ExcelJet](https://exceljet.net/) - Exemples de formules
-   [Power Query Documentation](https://docs.microsoft.com/power-query/) - Guide complet M Language

**Standards Internationaux :**

-   [ISO](https://www.iso.org/) - Gestion caractères internationaux
