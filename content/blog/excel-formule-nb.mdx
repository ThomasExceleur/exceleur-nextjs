...
excerpt: "Maîtrisez les fonctions NB et NBVAL pour compter les cellules dans Excel."
description: "Guide complet des fonctions NB, NBVAL et NB.VIDE dans Excel. Syntaxe, différences et exemples pratiques."
...
- Erreurs
- Valeurs logiques
- Formules (meme si résultat vide "")
...
Equivalent à MOYENNE mais explicite.
...
### Vérifier avant calcul

```excel
=SI(NB(A1:A10)>0; MOYENNE(A1:A10); "Pas de données")
```

## Tableaux structurés

Dans un tableau, utilisez des références structurées :
...
1. **Choisissez la bonne fonction** selon le type de données
