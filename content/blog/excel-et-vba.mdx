...
Si vous êtes intéressé par des **cours de formation** plus approfondis, notre formation [**La Machine**](https://www.exceleur.fr/formations-excel/la-machine-liste-attente/) pourrais bien vous intéresser.

N'hésitez pas à vous inscrire à [**la liste d'attente**](https://www.exceleur.fr/formations-excel/la-machine-liste-attente/) pour ne pas manquer la prochaine ouverture de la formation.
